...
Contained in this main branch is the python code I use to clean and prep the daily and weekly charts. The unique charts themselves are pulled from [Spotifycharts.com](https://charts.spotify.com) in daily or weekly batches - on chart per day/week per region. There's a bit a cleaning that needs to happen in order to get it ready.
