...
outpath = '/Users/sm029588/OneDrive - Cerner Corporation/PycharmProjects/Spotify-Top-200/Weekly'
...
for f in sorted(glob('*.csv')):
    ...
    df['chart_url'] = 'https://charts.spotify.com/charts/view/regional-'+region+'-weekly/'+chart_dt
